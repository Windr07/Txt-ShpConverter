...
namespace WLib.CoordCoverter.View
{
    ...
    public partial class InputForm : Form
    {
        ...
        public InputForm(string title, string btnText)
        {
            InitializeComponent();
            this.Text = title;
        ...
        /// <summary>
        /// 实例化输入框窗体，设置窗口标题、提示文字、确定按钮的文字、默认值
        /// </summary>
        /// <param name="title">窗口标题</param>
        /// <param name="tips">提示文字</param>
        /// <param name="btnText">确定按钮的文字</param>
        /// <param name="defaultValue">默认值</param>
        public InputForm(string title, string btnText, string tips, string defaultValue = null)
        {
            InitializeComponent();
            this.Text = title;
