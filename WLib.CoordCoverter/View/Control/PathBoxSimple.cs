...
namespace WLib.CoordCoverter.View.Control
{
    ...
    public partial class PathBoxSimple : UserControl
    {
        ...
        /// 选择按钮是否可用
        /// </summary>
        public bool SelectEnable { get => this.btnSelect.Enabled; set => this.btnSelect.Enabled = value; }
        /// <summary>
        /// 路径文本框
        /// </summary>
